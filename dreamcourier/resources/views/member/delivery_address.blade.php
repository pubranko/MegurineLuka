...
<div class="mbr-message-box">
    ...
    <form id="member-address-form" method="POST" action="{{ url('/member/delivery_address') }}">
        ...
        <div class="form-group{{ $errors->has('address_select') ? ' has-error' : '' }}">
            <input type="radio" name="address_select" value="登録済み住所" @if(old('address_select')=='登録済み住所') checked @endif>登録されている住所<br/>
            <input type="radio" name="address_select" value="個別指定住所" @if(old('address_select')=='個別指定住所') checked @endif>個別指定・配達先住所
        </div>
        ...
        <!-- -->
            ...
            <div class="form-group{{ $errors->has('phone_select') ? ' has-error' : '' }}">
                <input type="radio" name="phone_select" value="登録済み電話番号" @if(old('phone_select')=='登録済み電話番号') checked @endif>登録されている電話番号<br/>
                <input type="radio" name="phone_select" value="個別指定電話番号" @if(old('phone_select')=='個別指定電話番号') checked @endif>個別指定・連絡先電話番号
            </div>
