            ...
            <div class="u-margin--tb-50 form-group{{ $errors->has('delivery_time') ? ' has-error' : '' }}">
                <div class="form-group{{ $errors->has('wk_delivery_datetime') ? ' has-error' : '' }}">
                    ...
                    <select id="delivery_time" class="p-member-info__delivery_time" name="delivery_time">
                        ...
                        <option value='2:00〜4:00' @if(old('delivery_time')=='2:00〜4:00' ) selected @endif>2:00〜4:00
                        </option>
                        <option value='4:00〜6:00' @if(old('delivery_time')=='4:00〜6:00' ) selected @endif>4:00〜6:00
                        </option>
                        <option value='6:00〜8:00' @if(old('delivery_time')=='6:00〜8:00' ) selected @endif>6:00〜8:00
                        </option>
                        <option value='8:00〜10:00' @if(old('delivery_time')=='8:00〜10:00' ) selected @endif>8:00〜10:00
                        </option>
                        <option value='10:00〜12:00' @if(old('delivery_time')=='10:00〜12:00' ) selected @endif>
                            10:00〜12:00</option>
                        <option value='12:00〜14:00' @if(old('delivery_time')=='12:00〜14:00' ) selected @endif>
                            12:00〜14:00</option>
                        <option value='14:00〜16:00' @if(old('delivery_time')=='14:00〜16:00' ) selected @endif>
                            14:00〜16:00</option>
                        <option value='16:00〜18:00' @if(old('delivery_time')=='16:00〜18:00' ) selected @endif>
                            16:00〜18:00</option>
                        <option value='18:00〜20:00' @if(old('delivery_time')=='18:00〜20:00' ) selected @endif>
                            18:00〜20:00</option>
                        <option value='20:00〜22:00' @if(old('delivery_time')=='20:00〜22:00' ) selected @endif>
                            20:00〜22:00</option>
                        <option value='22:00〜24:00' @if(old('delivery_time')=='22:00〜24:00' ) selected @endif>
                            22:00〜24:00</option>
                    </select>
