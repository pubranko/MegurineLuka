        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <a>{{$wk_product_thumbnail_filename}}</a>
                    </div>
                    <div class="col-md-6">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/operator/product/register') }}">
                        {{ csrf_field() }}
                        <input id="product_name" type="hidden" class="form-control" name="product_name" value={{old('product_name')}}>
                        <input id="sales_period_from" type="hidden" class="form-control" name="sales_period_date_from" value={{old('sales_period_date_from')}}>
                        <input id="sales_period_from" type="hidden" class="form-control" name="sales_period_time_from" value={{old('sales_period_time_from')}}>
                        <input id="sales_period_to" type="hidden" class="form-control" name="sales_period_date_to" value={{old('sales_period_date_to')}}>
                        <input id="sales_period_to" type="hidden" class="form-control" name="sales_period_time_to" value={{old('sales_period_time_to')}}>
