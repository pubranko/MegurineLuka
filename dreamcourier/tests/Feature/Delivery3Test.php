...
class Delivery3Test extends TestCase
{
    ...
    public function testExample()
    {
        ...
        $this->assertDatabaseHas('product_cart_lists', ['id'=>300]);  #DBに追加されたことを確認
        #③カート一覧で購入手続きを行う商品を選択
        $response = $this->actingAs($user,'member')->get('/member/delivery_address?cartlist_id=300'); #存在するカートリストID
