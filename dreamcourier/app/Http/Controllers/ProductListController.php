...
class ProductListController extends Controller
{
    ...
    public function productSearch(Request $request){
        ...
        if(isset($search_word['product_search_tag'])){                                                  #検索タグがあった場合
            $product_queries->Where("product_tag","like","%".$search_word['product_search_tag']."%");   #対象のタグで絞り込み
        }
        ...
        if(isset($search_word['product_search_keyword'])){                  #検索キーワードがあった場合
            $wk_list["introduction_tag"] = "キーワード：".$search_word['product_search_keyword']."の検索結果";   #入力された検索キーワード
        }
        if(isset($search_word['product_search_tag'])){                      #検索タグがあった場合
            $wk_list["introduction_tag"] = "タグ：".$search_word['product_search_tag']."の検索結果";   #入力された検索キーワード
        }
